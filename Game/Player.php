...
class Player {
    ...
    public function take_turn($players,$position,$deck) {
        $this->display_hand();
        echo "\033[1mIt is your turn.\033[0m\n\n";
        sleep(3);
        $max = count($players);
        $p = $position+1;
        $finished = false;
        while (!$finished) {
            ...
            echo "\033[1mView a hand:\033[0m enter a number between \033[1m\033[38;2;255;215;0m1\033[0m and \033[38;2;255;215;0m\033[1m$max\033[0m (You are \033[1m\033[38;2;255;215;0m$p\033[0m). Dealer is \033[1m\033[38;5;160m$max\033[0m\n";
